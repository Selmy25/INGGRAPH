...
//ћетод ниже генерирует матрицу перспективы, одна из компонентов, умножа€ которые получаем итоговое преобразование
...
//Ёта функции инициализирует три отдельные матрицы дл€ преобразовани€ с текущими параметрами. 
//ќно умножает их одну за другой и выводит итоговый результат.
const Matrix4f* Pipeline::GetTrans()
{
	...
	//ћы ставим матрицу перспективы первой в череде умножени€ матриц, которые генерирует итоговое преобразование.
	//¬спомним, что вектор позиции умножаетс€ с правой стороны от итоговой матрицы. 
	//ѕоэтому сначала масштабируем, затем вращаем, перемещаем и наконец проецируем.
